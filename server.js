...
function updateSlackChannel(id, state) {
  ...
  if (lastTimestamp) {
    url = 'https://slack.com/api/chat.delete?token=' + process.env.API_TOKEN + '&channel=bathroom-bot&ts=' + lastTimestamp
  ...
  postUrl = 'https://slack.com/api/chat.postMessage?token=' + process.env.API_TOKEN + '&channel=bathroom-bot&text=The%20' + roomName + '%20bathroom%20is%20' + stateText
